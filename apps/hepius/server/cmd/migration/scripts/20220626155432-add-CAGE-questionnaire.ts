...
import { buildCAGEQuestionnaire } from '../../static';
// ------------------------------------------------------------------------------------------------
...
export const up = async (dryRun: boolean, db: Db) => {
  ...
  await qService.createQuestionnaire(buildCAGEQuestionnaire());
};
...
export const down = async (dryRun: boolean, db: Db) => {
  ...
  await questionnaireModel.deleteOne({ type: QuestionnaireType.cage });
};
