...
aws sqs create-queue --queue-name ChangeEventQ-local --endpoint-url=http://localhost:4566
...
aws s3 cp ./apps/hepius/server/cmd/analytics/scripts/data_enrichment.sql s3://laguna-analytics/scripts/data_enrichment.sql --endpoint-url=http://localhost:4566
